...
class NodeStory(Base):
    """A node-based visual-novel story (narration / dialogue / quiz nodes).

    Pre-made stories have `user_id` NULL and `is_premade` true; custom stories
    are owned by a user. `nodes` is generated by AI on first play.
    """
    ...
    # The generated node sequence; null until the story is first played.
